	...
	[
		...
		Describe<MethodologyKindInput>(
			...
			new()
			{
				...
				["autoWireFrom"] = "Auto-wire this kind's boards to the sole active board of the named kind (e.g. work → \"spec\"), so the task_spec link resolves without naming a board. Omitted = no auto-wire.",
