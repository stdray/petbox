...
static class ModuleMcp
{
	...
	public const string SizeGuidanceText =
		...
		"number for it. Split large batches into multiple calls. THE FIX IS NOT CAREFUL TYPING: for " +
		"non-ASCII prose, keep the text out of this call entirely. Write it to a file, POST the raw " +
