...
// The task-board twin of ProjectCanonSeeder (work
...
// tasks_methodology_utility_upsert). ITS OWN FILE for the same reason that one is: a fresh
...
{
	// Best-effort, NEVER throws — same contract as ProjectCanonSeeder: a storage hiccup here must
	// not turn into a refused project creation (or a failed startup pass touching every OTHER
